...
<table>
    <tr>
        <td><?php  echo "<center>"."<h2>".$time;  echo "</br>";  echo $print_stock_product_id; echo " - "; echo $print_stock_stocks_id."</h2>"."</center>";?>
        </td>
    </tr>
</table>
<?php
...
<head>
    ...
    <link rel="stylesheet"
        href="<?php echo $backpath; ?>plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
    <!-- iCheck -->
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    if ($create_Collection=="done") {
     ...
     ?>
            ...
            <a href="?create_collection=new"><button type="button" class="btn btn-primary">Create Collection
                    ID</button></a>
    ...
    ?>
                        ...
                        <tr>
                            ...
                            <td><a
                                    href="?openstockcollectionid=<?php echo $CollectionID ?>&Ctagegory=Products&products_type=new_stocks"><button
                                        type="button"
                                        class="btn btn-outline-info btn-rounded"><?php echo $CollectionID ?></button></a>
                            </td>
                            <td><?php echo $Collectioncreate_time ?></td>
                            <td><?php echo $Collectioncreate_user ?></td>

                            <?php if ($Collection_results < 0): ?> <td><span
                                    class="badge badge-pill badge-success mb-1"><?php echo $Collection_results ?></span>
                            </td> <?php endif; ?>
                            <?php if ($Collection_results > 0): ?> <td><span
                                    class="badge badge-pill badge-danger mb-1"><?php echo $Collection_results ?></span>
                            </td> <?php endif; ?>
                            <?php if ($Collection_results == 0): ?> <td><span
                                    class="badge badge-pill badge-primary mb-1"><?php echo $Collection_results ?></span>
                            </td> <?php endif; ?>


                            <td><?php echo $Collectionstatus ?></td>
                            <td><span
                                    class="badge badge-pill badge-danger mb-1"><?php echo $Collection_products_amount ?></span>
                            </td>
                            <td><span
                                    class="badge badge-pill badge-danger mb-1"><?php echo $Collection_expence_amount ?></span>
                            </td>
                            <td><span
                                    class="badge badge-pill badge-danger mb-1"><?php echo $Collection_total_cost ?></span>
                            </td>
        ...
        ?>
                        <tr>
                            ...
                            <?php if ($total_Collection_results < 0): ?> <td><span
                                    class="badge badge-pill badge-success mb-1"><?php echo $total_Collection_results ?></span>
                            </td> <?php endif; ?>
                            <?php if ($total_Collection_results > 0): ?> <td><span
                                    class="badge badge-pill badge-danger mb-1"><?php echo $total_Collection_results ?></span>
                            </td> <?php endif; ?>
                            <?php if ($total_Collection_results == 0): ?> <td><span
                                    class="badge badge-pill badge-primary mb-1"><?php echo $total_Collection_results ?></span>
                            </td> <?php endif; ?>
                            ...
                            <td><span
                                    class="badge badge-pill badge-danger mb-1"><?php echo $total_Collection_expence_amount ?></span>
                            </td>
                            <td><span
                                    class="badge badge-pill badge-danger mb-1"><?php echo $total_Collection_total_cost ?></span>
                            </td>
    ...
    ?> <a href="./add_server_product.php" target="_blank"><button type="button" class="btn btn-info"><i
                        class="ik ik-share"></i>Upload New Product</button></a><?php
    ...
    ?><center>
                <a href="?openstockcollectionid=<?php echo $openstockcollectionid ?>&Ctagegory=totalinfo"><button
                        type="button" class="btn btn btn-outline-info">Total Info</button></a>
                <a
                    href="?openstockcollectionid=<?php echo $openstockcollectionid ?>&Ctagegory=Products&products_type=new_stocks"><button
                        type="button"
                        class="btn btn-outline-success">Products(<?php echo $Collection_products_amount ?>)</button></a>
                <a href="?openstockcollectionid=<?php echo $openstockcollectionid ?>&Ctagegory=Expence"><button
                        type="button"
                        class="btn btn-outline-danger">Expence(<?php echo $Collection_expence_amount ?>)</button></a>
            </center><?php
    ...
    ?>
            ...
            if ($Collectionstatus == "pending") {
              ...
              if ($editid == 20689) {
                ...
                ?> <a href="?openstockcollectionid=<?php echo $openstockcollectionid ?>&Ctagegory=totalinfo&editid=20689"><button
                                type="button" class="btn btn-dark"><i class="ik ik-edit-2"></i>Edit</button></a> <?php
              }
                  }
             ?>
                        ...
                        <form class="" action="" method="post">
                            <?php if ($editid == 20689): ?>
                            <button type="submit" name="update_info" class="btn btn-success"><i
                            ...
                            <ul>
                                <li>
                                    ...
                                    <div class="desc">
                                        <h3>Cash Amount:</h3>
                                        <h4>
                                          <span class="badge badge-pill badge-primary mb-1"><?php echo $Collection_Cash_Amount ?></span>
                                        </h4>
                                        <?php if ($editid == 20689): ?>
                                        <input type="number" name="Cash_Amount"
                                            value="<?php echo $Collection_Cash_Amount ?>">
                                        <?php endif; ?>
                                ...
                                <li>
                                    ...
                                    <div class="desc">
                                        <h3>Paid Old Due:</h3>
                                        <h4><span
                                                class="badge badge-pill badge-danger mb-1"><?php echo $Collection_Paid_Old_Due ?></span>
                                        </h4>
                                    </div>
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    <div class="desc">
                                        ...
                                        <h4><span
                                                class="badge badge-pill badge-warning mb-1"><?php echo $total_amount_pc ?></span>
                                        </h4>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="desc">
                                        <h3>Return Amount:</h3>
                                        <h4><span
                                                class="badge badge-pill badge-danger mb-1"><?php echo $Collection_Return_Amount ?></span>
                                        </h4>
                                        <?php if ($editid == 20689): ?>
                                        <input type="number" name="Return_Amount"
                                            value="<?php echo $Collection_Return_Amount ?>">
                                        <?php endif; ?>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="desc">
                                        <h3>Due Amount:</h3>
                                        <h4><span
                                                class="badge badge-pill badge-primary mb-1"><?php echo $Collection_Due_Amount ?></span>
                                        </h4>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="desc">
                                        ...
                                        <?php if ($Shortorextra < 0): ?> <h4><span
                                                class="badge badge-pill badge-success mb-1"><?php echo $Shortorextra ?>
                                                TK Extra</span></h4> <?php endif; ?>
                                        <?php if ($Shortorextra > 0): ?> <h4><span
                                                class="badge badge-pill badge-danger mb-1"><?php echo $Shortorextra ?>
                                                Tk Short</span> </h4> <?php endif; ?>
                                        <?php if ($Shortorextra == 0): ?> <h4><span
                                                class="badge badge-pill badge-primary mb-1"><?php echo $Shortorextra ?>
                                                Accounts Complete</span> </h4> <?php endif; ?>
    ...
    ?><div class="btn-group" role="group" aria-label="Basic example">
                <a
                    href="?openstockcollectionid=<?php echo $openstockcollectionid ?>&Ctagegory=Products&products_type=new_stocks"><button
                        type="button" class="btn btn-outline-secondary">New Stocks</button></a>
                <a
                    href="?openstockcollectionid=<?php echo $openstockcollectionid ?>&Ctagegory=Products&products_type=all_products"><button
                        type="button" class="btn btn-outline-secondary">ALL Products</button></a>
            </div><?php
    ...
    if(isset($_POST['new_update_price'])){
    ...
    ?>
            ...
            <form class="" action="" method="post" enctype="multipart/form-data">
                ...
                <img src="<?php echo  $changepriceid_Product_img; ?>" alt="<?php echo  $changepriceid_Product_img; ?>"
                    width="100" height="100">
                <input type="text" class="form-control" style="width:20%!important" name="new_update_price"
                    value="<?php echo $changepriceid_Paid_Price ?>"> <br>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h3>New Products</h3></br><input type="submit" name="print_barcode"
                                    value="Print All Selcted" class="btn btn-secondary">
                            </div>
    ...
    ?>
                                        <tr>
                                            <td><?php echo $n++ ; ?> </td>
                                            <td><input type="checkbox" class="checkitem" name="stock_id[]"
                                                    value="<?php echo $Spendingst_stock_id ?>"></td>
                                            <td><?php echo  $Spendingst_Product_id; ?></td>
                                            <td><a href="print_barcode.php?collection_id=<?php echo $openstockcollectionid ?>&product_id=<?php echo $Spendingst_Product_id ?>&stock_id=<?php echo $Spendingst_id ?>&token_id=<?php echo $Spendingst_token_id ?>"
                                                    target="_blank"><button type="button" class="btn btn-secondary"><i
                                                            class="ik ik-clipboard"></i>Print</button></a></td>

                                            <td><img src="<?php echo  $Spendingst_Product_img; ?>"
                                                    alt="<?php echo  $Spendingst_Product_img; ?>" width="100"
                                                    height="100"></td>

                                            <td><?php echo  $Spendingst_quantity; ?></td>
                                            <td><?php echo  $Spendingst_Paid_Price; ?></td>
                                            <?php if ($Spendingst_stock == "pending" ): ?>
                                            <td><a href="?openstockcollectionid=<?php echo $openstockcollectionid ?>&Ctagegory=Products&products_type=new_stocks&deletestockid=<?php echo $Spendingst_id; ?>"
                                                    onclick="return confirmation()"><button type="button"
                                                        class="btn btn-danger"><i
                                                            class="ik ik-info"></i>DELETE</button></a></td>
                                            <td><a href="?openstockcollectionid=<?php echo $openstockcollectionid ?>&Ctagegory=Products&products_type=new_stocks&changepriceid=<?php echo $Spendingst_id; ?>"
                                                    onclick="return confirmation()"><button type="button"
                                                        class="btn btn-warning"><i class="ik ik-edit-2"></i></i>Change
                                                        Price</button></a></td>
    ...
    ?>
                ...
                <center>
                    <div class="alert bg-dark alert-dark text-white" role="alert">Total Quentity: <span
                            class="badge badge-pill badge-success mb-1"><?php echo $total_quentity ?></span> Total
                        Products Amount: <span
                            class="badge badge-pill badge-success mb-1"><?php echo $total_amount ?></span> </div>
                </center>
    ...
    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="<?php  echo $row['Product_img']; ?>"
                                                    alt="<?php  echo $row['Product_Name']; ?>" width="100" height="100">
                                            </td>
                                            <td><a href="add_stock_collect.php?openstockcollectionid=<?php echo $openstockcollectionid ?>&newstockid=<?php echo $id; ?> "
                                                    target="_blank"><button type="button" class="btn btn-success"><i
                                                            class="ik ik-check-circle"></i>Add Stock</button></a> </td>
    ...
    ?>
            ...
            ?>
                            <tr>
                                ...
                                <td><a href="?openstockcollectionid=<?php echo $openstockcollectionid ?>&Ctagegory=Expence&deleteexpid=<?php echo $exp_id; ?>"
                                        onclick="return confirmation()"><button type="button" class="btn btn-danger"><i
                                                class="ik ik-info"></i>DELETE</button></a></td>
    ...
    ?>
                ...
                <center>
                    <div class="alert bg-dark alert-dark text-white" role="alert"> Total Expence: 
                      <span class="badge badge-pill badge-danger mb-1"><?php echo $total_exp ?></span> 
                    </div>
                </center>
