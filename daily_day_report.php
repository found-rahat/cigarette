...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="Daily_sell_report.php">Home</a></li>
    ...
    <?php
    $Outbound_Time = $_GET['Outbound_Time'];
     ?>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">OutBound Date : <?php echo $Outbound_Time; ?></h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  ...
                  <tbody>
                    ...
                    $list_product = "SELECT * FROM `cigarete_order_outbound` WHERE `outbound_time`='$Outbound_Time'";
                            ...
                            while ($row_sku = mysqli_fetch_array($result_sku)) {
                              ...
                              $total_Price_sql = "SELECT SUM(`buy_price`) AS `buy_price` FROM `cigarete_order_outbound` WHERE `outbound_time`='$Outbound_Time'";
                ...
                <?php }} ?>
                  ...
                  <tr>
                    ...
                    <th>Product ID</th>
                    <th>Product_img</th>
                    <th>Total: <?php echo $total_Price_sql_result1_echo_print; ?></th>
                    <th>Outbound Date</th>
                    <th>Collection Date</th>
                    <th>Status</th>
                  </tr>
